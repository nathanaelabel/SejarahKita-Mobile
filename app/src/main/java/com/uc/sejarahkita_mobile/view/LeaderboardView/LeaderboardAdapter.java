...
public class LeaderboardAdapter extends RecyclerView.Adapter<LeaderboardAdapter.LeaderboardViewHolder> {
    ...
    public void setLeaderboardList(List<Leaderboard.Leaderboards> leaderboardList) {
        List<Leaderboard.Leaderboards> header = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull LeaderboardViewHolder holder, int position) {
        if (position > 0) {
            ...
            holder.txt_username_detail_leaderboard_fragment.setText("User " + String.valueOf(results.getId_student()));
            holder.txt_ranked_point_detail_leaderboard_fragment.setText(String.valueOf(results.getRanked_point()));
        }
    }
